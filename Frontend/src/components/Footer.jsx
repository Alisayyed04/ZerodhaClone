        ...
        <>
            <footer className="footer">
                <div className="footer-links">
                    <span><h2>Zerodha</h2></span>
                    <p>© 2010 - 2025, Zerodha Broking Ltd.
                        All rights reserved.</p>
                    <ul className="footer-links">
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a twitter icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a facebook icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a instagram icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a Linkedin icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a youtube icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a whatsapp icon here
                        </a></li>
                        <li className="footer-links-items"><a className="footer-link-icon" href="#">
                            Need a telegram icon here
                        </a></li>

                    </ul>
                </div>
                <div className="Main-footer-Account">
                    <ul>
                        <h3>Account</h3>
                        <li>
                ...
                <div className="static-footer-paragraph">
                    <p>
                ...
                <div className="last-links">
                    <ul>
                        ...
                        <li><a href="#">For Investors attention</a></li>
